...
export const Copy = (p) => (<Icon {...p}><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></Icon>);
...
export const Calendar = (p) => (<Icon {...p}><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></Icon>);
...
export const Icons = { CheckCircle, XCircle, InfoCircle, AlertTriangle, ChevronDown, ChevronUp, ChevronLeft, ChevronRight, ArrowRight, ArrowLeft, Plus, Minus, X, Check, Search, Eye, EyeOff, Edit, Trash, Download, Upload, Copy, Link, Refresh, Filter, Calendar, Clock, User, Home, Heart, Star, Bell, Settings, LogOut };
